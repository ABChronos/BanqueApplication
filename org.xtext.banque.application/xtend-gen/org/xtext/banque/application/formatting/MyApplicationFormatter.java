 ...
 * generated by Xtext
 */
package org.xtext.banque.application.formatting;
...
public class MyApplicationFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private MyApplicationGrammarAccess _myApplicationGrammarAccess;
  
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword,Keyword>> _findKeywordPairs = this._myApplicationGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._myApplicationGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._myApplicationGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._myApplicationGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._myApplicationGrammarAccess.getML_COMMENTRule();
